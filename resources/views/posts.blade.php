...
@section('container')
  ...
  @if ($posts->count())
    <div class="card mb-3">
      {{-- Post Image --}}
      @if ($posts[0]->image)
          <div style="max-height: 4000px; overflow:hidden">
    ...
    <div class="row">
      @foreach ($posts->skip(1) as $post)
        ...
        <div class="col-md-4 mb-3">
          <div class="card">
            <div class="position-absolute px-3 py-2" style="background-color: rgb(0, 0, 0, 0.7)"><a href="/categories/{{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
            @if ($post->image)
